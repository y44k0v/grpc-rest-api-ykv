...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldEmail, user.FieldAddress, user.FieldLevel:
			values[i] = new(sql.NullString)
		case user.FieldCreatedAt, user.FieldLastUpdated:
	...
	for i := range columns {
		...
		case user.FieldOrderID:
			if value, ok := values[i].(*[]byte); !ok {
				...
				if err := json.Unmarshal(*value, &u.OrderID); err != nil {
					return fmt.Errorf("unmarshal field Order_id: %w", err)
				}
			}
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.OrderID))
	builder.WriteString(", ")
